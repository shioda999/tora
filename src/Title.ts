...
export class Title extends Scene {
	...
	constructor(container: PIXI.Container) {
		...
		this.text = new PIXI.Text("寅", style)
		...
		this.item_manager.appendItem("Start", HEIGHT / 15, [0xffffff, 0xcccccc, 0x555555], true)

		const text2 = new PIXI.Text("Click or Press Enter Key...", new PIXI.TextStyle({
			fontFamily: "Arial",
			fontWeight: "normal",
			fontSize: fontsize,
